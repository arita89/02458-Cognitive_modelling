...
y_train   = statarray.mean_VarName6; %VarName6 is smiling/not smiling
%%
...
%%Split W_sub in train and test set
...
immse(y_Test, predict(fitrensemble(X_Train,y_Train), X_Test))%<----------------this works
