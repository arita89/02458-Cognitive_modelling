...
%lax << d_prime/2
%moderate  = d_prime/2
C = [-0.05 0.5 1.5];%<-- CRITERION (ALSO C or Beta)to modify to change the observer attitude! 
d= ones(size(C));
...
%% ANSWER  for a particular separation of Noise and Signal+Noise distributions 
% the value of d' is CONSTANT for all possible criterion positions
for j =1:3
